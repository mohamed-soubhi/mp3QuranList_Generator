...
while(playcount):
    ...
    Surah_start = int(input("Surah start: "))   
    Surah_end   = int(input("Surah end  : "))
    Ayah_start  = int(input("Ayah start : ")) 
    Ayah_end    = int(input("Ayah end   : "))
    ...
    for Q in Quraa2 :
        for AyaIndex in range(AyaIndexStart,AyaIndexEnd+1):
            surah = str(Surah_aya(AyaIndex)[0])
            ayah  = str(Surah_aya(AyaIndex)[1])

            completeName = sound(Q[Quraa2Name], AyaIndex)
